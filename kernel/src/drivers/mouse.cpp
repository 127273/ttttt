...
uint8_t MouseDriver::mouse_cycle  = 0;
uint8_t MouseDriver::mouse_byte[4] ;
int32_t MouseDriver::mouse_x = 0;
int32_t MouseDriver::mouse_y = 0;
int32_t MouseDriver::mouse_x_difference = 0;
int32_t MouseDriver::mouse_y_difference = 0;
int32_t MouseDriver::mouse_buttons = 0;


MouseDriver::MouseDriver(InterruptManager* manager, uint8_t interruptLine)
...
void MouseDriver::HandleInterrupt(isr_ctx_t *regs)
{
...
finish_packet:
    { 
      ...
      mouse_y -= mouse_y_difference;
                   // Vesa::vesa_video_info.width;
      if (mouse_x > vesa_video_info.width) mouse_x = vesa_video_info.width;
      if (mouse_x < 0) mouse_x = 0;
      if (mouse_y > vesa_video_info.height) mouse_y = vesa_video_info.height;
