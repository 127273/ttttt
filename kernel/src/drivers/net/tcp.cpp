...
void TransmissionControlProtocolProvider::Send(TransmissionControlProtocolSocket *socket, uint8_t *data, uint16_t size, uint16_t flags)
{
    ...
    uint8_t *buffer = (uint8_t *)malloc(lengthInclPHdr);
...
{
    TransmissionControlProtocolSocket *socket = (TransmissionControlProtocolSocket *)malloc(sizeof(TransmissionControlProtocolSocket));

    if (socket != 0)
    {
        new (TransmissionControlProtocolSocket) (TransmissionControlProtocolSocket(this));
