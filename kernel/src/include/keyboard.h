...
namespace myos{
     namespace drivers{
        ...
        class KeyboardDriver : public myos::hardware::InterruptHandler, public myos::drivers::Driver
        {
        ...
        public:
            KeyboardDriver(myos::hardware::InterruptManager* manager, uint8_t interruptLine);
            ~KeyboardDriver();
