...
start:
    ...
    ; load the 64-bit GDT
    lgdt [(GDT64Pointer64 - KERNEL_VMA)]
...
.map_p3_table:
    mov eax, 0x40000000      ; 1GB page
    mul ecx            ; start address of ecx-th page
    or eax, 0b10000011 ; present + writable + huge
    mov [(p3_table - KERNEL_VMA) + ecx * 8], eax ; map ecx-th entry

    inc ecx            ; increase counter
    cmp ecx, 8       ; if counter == 512, the whole P2 table is mapped
