...
extern _ZN4myos8hardware16InterruptManager15handleInterruptEP14isr_ctx_struct;
section .text
bits 64
...
isr_common_stub:
    ...
    ; call handler
    mov rdi, rsp
    call _ZN4myos8hardware16InterruptManager15handleInterruptEP14isr_ctx_struct
;isr_handler
